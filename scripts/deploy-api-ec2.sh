...
for line in text.splitlines():
    if line.startswith("S3_ENDPOINT="):
        ...
        lines.append(
            "CORS_ORIGIN=http://rembeh.antikra.com,https://rembeh.antikra.com,http://get.rembeh.antikra.com,https://get.rembeh.antikra.com,http://15.240.28.47,https://15.240.28.47,http://localhost:3000,http://127.0.0.1:3000"
        )
