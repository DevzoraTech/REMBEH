...
import { LoanReminderFilter } from './dto/loan-reminders.dto';
...
export class LoanRemindersService {
  ...
  private loanReminderMetrics(
     ...
     * CRITICAL:
     *
     * paymentStartDate is the first contractual repayment date.
     *
     * Do not use disbursement date when paymentStartDate exists.
     */
    const startDate =
     ...
     * OCCURRENCES that have become due.
     *
     * Example:
     *
     * Daily:
     ...
     * IMPORTANT:
     *
     * Today's currently scheduled instalment is DUE,
     * not yet OVERDUE.
     *
     * Therefore one currently-due occurrence is removed from
     * missed occurrences.
     */
    ...
    /*
     * Existing reminder filters use the field name overdueDays.
     *
     * For DAILY products, missed occurrences are equivalent to
     * missed repayment days.
     *
     * For non-daily products this represents missed contractual
     * instalments rather than literal calendar days.
     *
